<%@ Page Language="C#" MasterPageFile="~/web/index.master" AutoEventWireup="true" CodeFile="projectInfo.aspx.cs" Inherits="web_projectInfo" Title="项目详情" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container" width="100%">
        ...
        <div width="100%">
            ...
            <i id="icon1" runat="Server" class="icon-pencil"></i><a runat="Server" id="a1" href="">编辑</a>
        </div>
       ...
       <div width="100%">
            <div width="100%">
                <span> <strong>项目成员</strong> </span><i id="icon3" runat="Server" class="icon-plus-sign"></i>
                <a id="a3" runat="Server"  data-toggle="modal" href="#myModal" data-keyboard="false" data-backdrop="false">添加</a>
                    ...
                    <asp:Repeater runat="Server"  ID="rpUserList">
                        <ItemTemplate>
                            <tr align="center">
                                ...
                                <td align="center">
                                    <asp:LinkButton OnCommand="lbtnRpDelete_Command" runat="Server" ID="lbtnRpDelete" CommandName="del" Text="删除" CausesValidation="false" CommandArgument='<%#Eval("UserID") %>'></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <div>
            <div>
                ...
                <i id="icon2" runat="Server" class="icon-plus-sign"></i><asp:LinkButton ID="a2" runat="server" CommandName="addSubTask" 
                    ...
                    <asp:Repeater ID="rpSubTask" runat="Server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton OnCommand="rpLbtnModify_Command" runat="Server" ID="rpLbtnModify" CausesValidation="false" Text="编辑" CommandName="modify" CommandArgument='<%# Eval("TaskId") %>'></asp:LinkButton>
                                    <asp:LinkButton OnCommand="rpLbtnDel_Command" ID="rpLbtnDel"  runat="Server" OnClientClick="return confirm('确定删除？');" CausesValidation="false" Text="删除" CommandName="del" CommandArgument='<%# Eval("TaskId") %>'></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <div>
            <div>时间进度：计划时间<asp:Label runat="Server" ID="lblPlanDays" Text=""></asp:Label>
            天，已执行时间<asp:Label runat="Server" ID="lblRealDays" Text=""></asp:Label>。完成进度为
            ...
            <div>子任务完成进度</div>
            <div class="well">
               <asp:Button runat="Server" class="btn btn-primary disabled" style="margin-top:10px;" Text="开始" /><i style="margin-top:8px;" class="icon-arrow-right"></i>
               <asp:Repeater runat="Server" ID="rpSubTaskState">
                    <ItemTemplate>
                    <asp:Button runat="Server" style="margin-top:10px;" ID="btnSubTaskState" class='<%#Eval("TaskState") %>' Text='<%#Eval("TaskName") %>' /><i style="margin-top:8px;" class="icon-arrow-right"></i>
                    </ItemTemplate>
               </asp:Repeater>
               <asp:Button ID="Button1" runat="Server" class="btn btn-primary disabled" style="margin-top:10px;" Text="结束" />
            </div>
        </div>
