<%@ Page Language="C#" Async="true" AutoEventWireup="true" MasterPageFile="~/web/index.master"
    CodeFile="ModifyPartnerResource.aspx.cs" Inherits="web_ModifyPartnerResource"
    Title="修改合作伙伴资源" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  function modifyPartnerResource() 
  {
         if(confirm("确定要修改？"))
         {
            document.getElementById("<%=modifyPartnerResource_Hidden.ClientID %>").click();
         }
         else
            return;
  } 
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="修改合作伙伴资源"></asp:Label>
    </div>
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="addContact" Text="添加联系人" runat="server" OnClick="Add_PartnerContact"
                    Visible="False" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Button ID="modifyPartnerResource" Text="修改合作伙伴资源" runat="server" 
                    OnClientClick="modifyPartnerResource()" />
                <asp:Button ID="modifyPartnerResource_Hidden" Text="修改合作伙伴资源" runat="server" OnClick="Modify_PartnerResource"
                    Style="display: none" />
            </td>
        </tr>
    </table>
