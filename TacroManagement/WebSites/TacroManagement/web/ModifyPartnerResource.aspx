    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">
                    <asp:Label ID="Label1" runat="Server" Text="编辑合作伙伴资源"></asp:Label></li>
            </ul>
            ...
            <div class="form-horizontal control-group">
                ...
                <div class="controls">
                    <asp:TextBox runat="Server" ID="txtOrganName">
                    </asp:TextBox>
                </div>
            </div>
            <div class="form-horizontal control-group">
                ...
                <div class="controls">
                    <asp:TextBox runat="Server" ID="txtOrganIntro" Width="300px" Height="120px" TextMode="MultiLine">
                    </asp:TextBox>
                </div>
            </div>
            <div class="form-horizontal control-group">
                <div class="controls">
                    <asp:Button class="btn btn-primary" ID="addCustomer" Text="确定" runat="server" OnClick="Modify_PartnerResource" />
                    <asp:Button class="btn" ID="btnCancel" Text="取消" runat="Server" OnClick="Abort" />
                </div>
            </div>
            <div width="100%">
                <span><strong>合作伙伴资源联系人信息</strong> </span><i class="icon-plus-sign"></i><a href="AddPartnerContact.aspx?partnerResourceID=<%=partnerResourceID %>">添加</a>
            </div>
