...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <asp:Repeater runat="Server" ID="rpAlert">
            <ItemTemplate>
                <%#Container.DataItem%>
            </ItemTemplate>
        </asp:Repeater>
                    ...
                    <table style="width: 100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="width: 40%; padding-right: 10px; vertical-align: top">
                                <ul class="breadcrumb">
                                    <li><strong>
                                        <asp:LinkButton OnCommand="lBtnTaskMore_Command" runat="Server" ID="lBtnTaskMore"
                                            CommandName="more" CausesValidation="false" Text="待办事宜"></asp:LinkButton>
                                    </strong></li>
                                </ul>
                            ...
                            <td style="width: 60%; vertical-align: top">
                                <ul class="breadcrumb">
                                    <li><strong>
                                        <asp:LinkButton OnCommand="lBtnProjectStateMore_Command" runat="Server" ID="lBtnProjectStateMore"
                                            CommandName="more" CausesValidation="false" Text="项目动态"></asp:LinkButton>
                                    </strong></li>
                                </ul>
                                <table class="table table-striped table-bordered table-condensed">
                                    <tr>
                    ...
                    <table style="width: 100%" cellpadding="0" cellpadding="0" border="0">
                        <tr>
                            <td style="width: 40%">
                                <ul class="breadcrumb">
                                    <li><strong>
                                        <asp:LinkButton OnCommand="lBtnProjectMore_Command" runat="Server" ID="lBtnProjectMore"
                                            CommandName="more" CausesValidation="false" Text="项目管理"></asp:LinkButton>
                                    </strong></li>
                                </ul>
                                <table class="table table-striped table-bordered table-condensed">
                                    <tr>
