<%@ Page Language="C#" Async="true" EnableEventValidation="false" MasterPageFile="~/web/index.master"
    AutoEventWireup="true" CodeFile="AdvancedSearch.aspx.cs" Inherits="web_AdvancedSearch"
    Title="高级查询" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="row">
            ...
            <div class="control-group form-horizontal">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label1" runat="server" Text="文档名称"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label2" runat="server" Text="文档版本"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label3" runat="server" Text="关键词"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label4" runat="server" Text="文档所属部门"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label9" runat="server" Text="项目名称"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label10" runat="server" Text="子任务名"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label8" runat="server" Text="文档类别"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label5" runat="server" Text="上传人"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label6" runat="server" Text="上传时间上限"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <label class="control-label">
                        <asp:Label ID="Label7" runat="server" Text="上传时间下限"></asp:Label></label>
                    <div class="controls">
                ...
                <div class="form-horizontal control-group">
                    <div class="controls">
                        <asp:Button class="btn btn-primary" ID="AdvancedSearchButton" runat="server" Text="高级查询" OnClick="AdvancedSearchButton_Click" />
                        <asp:HyperLink class="btn" ID="HyperLink2" runat="server" NavigateUrl="~/web/Search.aspx">一般查询</asp:HyperLink>
                    </div>
                </div>
            </div>
            </form>
            <asp:GridView ID="DocGridView" runat="server" CellPadding="4" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="ExploreButton" runat="server" NavigateUrl="~/Search.aspx" CommandName="ExploreDocument"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="浏览" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="ModifyButton" runat="server" CommandName="ModifyDocument" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="修改" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="DownloadButton" runat="server" CommandName="DownloadDocument"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="下载" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="DeleteButton" runat="server" CommandName="DeleteDocument" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="删除" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
    ...
    <asp:Button ID="AdvancedSearchButton" runat="server" Text="高级查询" OnClick="AdvancedSearchButton_Click" />
