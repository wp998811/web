<%@ Page Language="C#" Async="true" AutoEventWireup="true" MasterPageFile="~/web/index.master"  CodeFile="ModifyGoverContact.aspx.cs" Inherits="web_ModifyGoverContact"  Title="修改政府联系人" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  function modifyGoverContact() 
  {
         if(confirm("确定要修改？"))
         {
            document.getElementById("<%=modifyGoverContact_Hidden.ClientID %>").click();
         }
         else
            return;
  } 
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
    	...
    	<tr>
    	    <td>
    	    <asp:Button id="modifyGoverContact" Text="修改政府联系人" runat="server" onclientclick="modifyGoverContact()"/>
    	    <asp:Button id="modifyGoverContact_Hidden" Text="修改政府联系人" runat="server"  OnClick="Modify_GoverContact" style= "display:none"/>
    	    </td>
    	</tr>
    </table>
</asp:Content>
