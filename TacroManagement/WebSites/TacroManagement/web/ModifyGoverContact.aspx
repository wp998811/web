...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
        ...
        <div style="padding-top:10px"></div>
            <ul class="breadcrumb">
                ...
                <li>
                  ...
                  <li class="active">
                    <asp:Label ID="Label1" runat="Server" Text="编辑政府资源联系人"></asp:Label></li>
            </ul>
        <div class="row" style="align:middle">
            ...
            <div class="form-horizontal control-group">
                ...
                <div class="form-horizontal control-group">
                    <div class="controls">
                        <asp:Button class="btn btn-primary" id="modifyGoverContact" Text="确定" runat="server" OnClick="Modify_GoverContact" />
