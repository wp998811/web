    ...
    <div class="container">
        <div class="row">
            <form class="form-horizontal">
                ...
                <div class="form-horizontal control-group">
                    <div class="controls">
                        <asp:Button class="btn btn-primary" id="addGoverContact" Text="确定" runat="server" OnClick="Add_GoverContact" />
...
<%--    <div>
        ...
        <asp:Label ID="Label1" runat="server" Text="添加政府资源联系人"></asp:Label>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
    	...
    	<tr>
    	    <td><asp:Button id="addGoverContact" Text="添加政府资源联系人" runat="server" OnClick="Add_GoverContact" /></td>
    	</tr>
    </table>--%>
</asp:Content>
