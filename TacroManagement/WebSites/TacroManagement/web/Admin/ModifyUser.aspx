<%@ Page Title="" Language="C#" MasterPageFile="~/web/Admin/admin.master" AutoEventWireup="true"
    CodeFile="ModifyUser.aspx.cs" Inherits="web_Admin_ModifyUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        ...
        <ul class="breadcrumb">
            <li><a href="#">用户管理</a><span class="divider">/编辑</span> </li>
        </ul>
        <div class="row">
            ...
            <div class="form-horizontal control-group">
                ...
                <div class="controls">
                    <div class="input-prepend">
                        <asp:TextBox runat="Server" ID="txtUserName" Text="" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="form-horizontal control-group">
