...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Text="添加临床资源联系人"></asp:Label>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
    	...
    	<tr>
    	    <td><asp:Button id="addClinicalContact" Text="添加临床资源联系人" runat="server" OnClick="Add_ClinicalContact" /></td>
    	</tr>
    </table>
</asp:Content>
