...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:Label ID="Label1" runat="server" Text="详细临床资源信息"></asp:Label>
    </div>
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td>
                <asp:Label ID="label_hospital1" runat="server" Text="医院名称" />
            </td>
            <td>
                <asp:Label ID="label_hospital2" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="label_departmentName1" runat="server" Text="科室名称" />
            </td>
            <td>
                <asp:Label ID="label_departmentName2" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="label_departIntro1" runat="server" Text="科室简介" />
            </td>
            <td>
                <asp:Label ID="label_departIntro2" runat="server" />
            </td>
        </tr>
    </table>
