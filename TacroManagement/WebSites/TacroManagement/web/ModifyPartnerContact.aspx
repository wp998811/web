<%@ Page Language="C#" Async="true" AutoEventWireup="true" MasterPageFile="~/web/index.master"  CodeFile="ModifyPartnerContact.aspx.cs" Inherits="web_ModifyPartnerContact"  Title="修改政府资源联系人" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
        ...
        <div style="padding-top:10px"></div>
            <ul class="breadcrumb">
                ...
                <li>
                  ...
                  <li class="active">
                    <asp:Label ID="Label1" runat="Server" Text="编辑合作伙伴资源联系人"></asp:Label></li>
            </ul>
        <div class="row" style="align:middle">
            ...
            <div class="form-horizontal control-group">
                ...
                <div class="form-horizontal control-group">
                    <div class="controls">
                        <asp:Button class="btn btn-primary" id="modifyPartnerContact" Text="确定" runat="server" OnClick="Modify_PartnerContact" />
