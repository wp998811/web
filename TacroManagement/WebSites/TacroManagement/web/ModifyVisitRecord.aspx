...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="修改拜访记录信息"></asp:Label>
    </div>
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="button_selectContact" Text="选择联系人" runat="server" OnClick="Select_Contact" />
            </td>
            <asp:TextBox ID="ContactID_TextBox" runat="server" Visible="false"></asp:TextBox>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="ContactGridView" runat="server" BackColor="White" BorderColor="#DEDFDE"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="选择">
                            <ItemTemplate>
                                <asp:CheckBox ID="Contact_CheckBox" runat="server" OnCheckedChanged="ContactCheckBoxChanged"
                                    AutoPostBack="True" />
        ...
        <tr>
            <td>
                <asp:Label ID="label_recordDetail" runat="server" Text="拜访记录" />
            </td>
            <td>
                <asp:TextBox ID="textBox_recordDetail" runat="server" TextMode="MultiLine" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="label_recordTime" runat="server" Text="拜访时间" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Button ID="button_modifyVisitRecord" Text="修改拜访记录" runat="server" OnClick="Modify_VisitRecord" />
            </td>
        </tr>
    </table>
</asp:Content>
