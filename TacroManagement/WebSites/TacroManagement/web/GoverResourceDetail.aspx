...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container" width="100%">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">
                <asp:Label ID="Label1" runat="Server" Text="政府资源信息"></asp:Label></li>
        </ul>
        <div width="100%">
            <span><strong>政府资源信息</strong> </span>
        </div>
        ...
        <div width="100%">
            <div width="100%">
                <div width="100%">
                    <span><strong>政府资源联系人</strong> </span>
                </div>
                <div width="100%">
                    <div style="padding-top: 10px;">
                    </div>
                    ...
                    <div style="height: 20px; text-align: center;">
                        <webdiyer:aspnetpager id="GoverContactPager" runat="server" alwaysshow="True" buttonimagealign="Middle"
                            ...
                            numericbuttontextformatstring="[{0}]" onpagechanged="GoverContact_PageChanged" pagesize="5"
