<%@ Page Language="C#" Async="true" AutoEventWireup="true" MasterPageFile="~/web/index.master"
    CodeFile="PartnerResourceList.aspx.cs" Inherits="web_PartnerResource" Title="合作伙伴资源列表" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:Label ID="Label1" runat="server" Text="合作伙伴资源列表"></asp:Label>
    </div>
        <table>
    <tr>
    <td>
    ...
    <tr>
    <td>
    <asp:Button ID="btnQuery" runat="server" Text="查询" OnClick="Query_PartnerResource"/>
    </td>
    </tr>
        <tr>
        <td>
    <asp:GridView ID="PartnerResourceGridView" runat="server" BackColor="White" BorderColor="#DEDFDE"
        BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"
        AutoGenerateColumns="False" OnRowEditing="PartnerResourceGridView_RowEditing"
        DataKeyNames="合作伙伴资源ID" OnRowDeleting="PartnerResourceGridView_RowDeleting" AllowPaging="True"
        ShowFooter="false" OnRowDataBound="PartnerResourceGridView_RowDataBound" OnRowCommand="PartnerResourceGridView_RowCommand">
        <Columns>
    ...
    <asp:Button ID="addPartnerResource" Text="添加合作伙伴资源" runat="server" OnClick="Add_PartnerResource" />
