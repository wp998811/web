<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userIndex.aspx.cs" Inherits="web_userIndex" %>
...
<body>
    ...
    <div style="height:100%">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="77%" height="25" valign="bottom">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="50">
                                                                <div align="center">
                                                                    <img src="../images/main_14.gif" width="48" height="19"></div>
                                                            </td>
                                                            <td width="50">
                                                                <div align="center">
                                                                    <img src="../images/main_16.gif" width="48" height="19"></div>
                                                            </td>
                                                            <td width="50">
                                                                <div align="center">
                                                                    <img src="../images/main_18.gif" width="48" height="19"></div>
                                                            </td>
                                                            <td width="50">
                                                                <div align="center">
                                                                    <img src="../images/main_20.gif" width="48" height="19"></div>
                                                            </td>
                                                            <td width="26">
                                                                <div align="center">
                                                ...
                                                <td width="220" valign="bottom" nowrap="nowrap">
                                                    <div align="right">
                                                        <span class="STYLE1"><span class="STYLE2">■</span> 今天是：2012年5月12日 星期一</span></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td height="23" valign="bottom">
                                                    <table width="58" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td height="20" style="cursor: hand" onmouseover="this.style.backgroundImage='url(images/bg.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#a6d0e7'; "
        ...
        <table width="100%" style="table-layout:fixed;"  border="0" cellpadding="0" cellspacing="0" style="height:100%;table-layout: fixed;">
        <tr>
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height:100%";table-layout: fixed;>
                    <tr>
                        <td width="171" id="frmTitle" nowrap name="fmTitle" align="center" valign="top">
                            <table width="171"  border="0" cellpadding="0" cellspacing="0" style="height:100%;table-layout: fixed;">
                                <tr>
                                    <td bgcolor="#7fbe26" style="width: 6px;">
                                        &nbsp;
                                    </td>
                                    <td width="165">
                                        <table width="165" style="height:100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td background="../images/main_51.gif" id="Td2">
                                                                            <div class="sec_menu">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td background="../images/main_51.gif" id="Td4">
                                                                            <div class="sec_menu">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td>
                        ...
                        <td width="6" style="width: 6px;" valign="middle" bgcolor="7fbe26">
                            <span class="navPoint" id="switchPoint" title="">
            ...
            <td width="6" bgcolor="#7fbe26" style="width: 6px;">
                &nbsp;
            </td>
        </tr>
    </table>
        <table width="100%" style="height:100%;table-layout:fixed;" border="0" cellspacing="0" cellpadding="0">
        <tr>
